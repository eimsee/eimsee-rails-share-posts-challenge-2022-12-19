...
Post.create!(title: "Fond de teint", content: "Fluide, léger et confortable, il apporte une touche de lumière au visage. Son effet soyeux et velouté sublime le teint qui retrouve à la fois éclat et fraîcheur.", url: "https://tse2.mm.bing.net/th?id=OIP.PuBataQ2JNoyxND4DAy6xgHaHa&pid=Api&P=0image.png", user: User.all.sample )
...
Post.create!(title: "Fard à paupière", content: "La promesse d’une texture sensorielle extraordinaire, d’un effet couleur intense et d’une couvrance maximale et longue durée!", url: "https://tse1.mm.bing.net/th?id=OIP.OZTYzCZvija8vURTiPCojgHaHa&pid=Api&P=0", user: User.all.sample )
